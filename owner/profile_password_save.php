<?php
/**
 * owner/profile_password_save.php
 *
 * Self-service password change for the logged-in owner. Always operates on
...
try {
    ...
    error_log('owner/profile_password_save.php failed: ' . $e->getMessage());
