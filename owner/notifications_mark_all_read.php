<?php
/**
 * owner/notifications_mark_all_read.php
 *
 ...
 * just flips every unread row this owner owns to is_read = 1.
 */
...
// (inventory/, purchase_orders/, reservation/, orders/ -- not just owner/
// itself, see reference_css_duplicated_across_modules for the same
// cross-module sharing pattern).
$returnParam = $_GET['return'] ?? '';
$validSegments = ['/owner/', '/inventory/', '/purchase_orders/', '/reservation/', '/orders/'];
