 ...
 * footer link (manager/includes/header.php) -- the bell itself only ever
 ...
 * links identically to its bell counterpart (managerNotifIcon()/managerNotifLink(),
 * manager/includes/notification_functions.php). Every link routes through
...
try {
    ...
    $unreadCountStmt->execute([$managerId]);
...
<title>Notifications | Manager Panel | OPO! Our Pinoy Original</title>
            ...
            <?php else: ?>
                <div class="owner-notif-cards">
                    ...
                    ?>
                        ...
                        <div class="<?= $cardClass ?>">
                        <?php endif; ?>
                            <span class="owner-notif-card-icon"><i class="ph <?= managerNotifIcon($n['type']) ?>" aria-hidden="true"></i></span>
                            <span class="owner-notif-card-body">
                                ...
                                <span class="owner-notif-card-meta"><?= htmlspecialchars($typeLabels[$n['type']] ?? ucfirst($n['type'])) ?> &middot; <?= htmlspecialchars(managerNotifTimeAgo($n['created_at'])) ?></span>
                            </span>
