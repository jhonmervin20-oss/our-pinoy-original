<?php
/**
 * manager/profile_password_save.php
 *
 * Self-service password change for the logged-in manager. Always operates on
...
try {
    ...
    error_log('manager/profile_password_save.php failed: ' . $e->getMessage());
