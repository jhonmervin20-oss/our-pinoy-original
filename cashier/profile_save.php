<?php
/**
 * cashier/profile_save.php
 *
 * Self-service update for the logged-in cashier's OWN first name, last
 ...
 * this form at all (see cashier/profile.php) -- those stay admin-only
...
try {
    ...
    // immediately instead of showing stale text until the cashier logs out.
    ...
    error_log('cashier/profile_save.php failed: ' . $e->getMessage());
