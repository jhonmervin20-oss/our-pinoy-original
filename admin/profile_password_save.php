<?php
/**
 * admin/profile_password_save.php
 *
 * Self-service password change for the logged-in admin. Always operates on
...
try {
    ...
    error_log('admin/profile_password_save.php failed: ' . $e->getMessage());
