 ...
 * admin/profile.php
 *
 * "My profile" -- the logged-in admin's own identity fields. Name, phone,
 * can be edited here; email and role remain read-only.
 */
...
require_once __DIR__ . '/../config/csrf.php';   // csrf_field(), for the password form below
...
<title>My Profile | Admin Panel | OPO! Our Pinoy Original</title>
...
<style>
    /* Details + password side by side once there's room; stacked below that. */
    .ad-profile-layout{ grid-template-columns: 1fr; max-width: 640px; gap: 20px; margin-inline: auto; }
    .ad-profile-layout > .owner-card{ margin-top:0; }
    @media (min-width: 1100px){
        .ad-profile-layout{ grid-template-columns: 1fr 1fr; max-width: 1160px; align-items: stretch; }
    }
</style>
</head>
<body>
...
<div class="owner-shell">
    ...
    <div class="owner-main">
        ...
        <main class="owner-content">
            ...
            <div class="owner-form-grid ad-profile-layout">

                <div class="owner-card op-profile-details" id="profileDetailsCard">
                    <div class="owner-card-head">
                        <div class="op-profile-identity">
                            <span class="owner-avatar" style="width:52px;height:52px;font-size:1.2rem;"><?= htmlspecialchars(Session::getInitials()) ?></span>
                            <div>
